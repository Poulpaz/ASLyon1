...
class TournamentDetailsViewModel(dataRepository: DataRepository, idTournament: Int) : BaseViewModel() {
    ...
    class Factory(private val repository: DataRepository, private val idTournament: Int) : ViewModelProvider.Factory {
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            return TournamentDetailsViewModel(repository, idTournament) as T
        }
    }
}